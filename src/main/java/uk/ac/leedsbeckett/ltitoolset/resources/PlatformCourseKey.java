...
/**
 * A two part key that identifies platform course based on the ID of the 
 * launching platform and that platform's own course ID.
 * 
 * @author jon
 */
public class PlatformCourseKey extends TwoStringKey implements Serializable
{
  /**
   * The standard constructor.
   * 
   * @param platformId Annotated to help with serialization as JSON.
   * @param courseId Annotated to help with serialization as JSON.
   */
  public PlatformCourseKey( 
